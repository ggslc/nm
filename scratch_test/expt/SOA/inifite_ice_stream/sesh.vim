...
silent only
silent tabonly
cd ~/new_model_code/src/nm/scratch_test/expt/SOA/inifite_ice_stream
...
badd +689 soa_test.py
badd +0 ../../../../utils/constants_years.py
argglobal
%argdel
$argadd soa_test.py
edit soa_test.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 1501 - ((30 * winheight(0) + 29) / 59)
...
wincmd w
argglobal
if bufexists(fnamemodify("../../../../utils/constants_years.py", ":p")) | buffer ../../../../utils/constants_years.py | else | edit ../../../../utils/constants_years.py | endif
balt soa_test.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
...
wincmd w
argglobal
if bufexists(fnamemodify("soa_test.py", ":p")) | buffer soa_test.py | else | edit soa_test.py | endif
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 391 - ((26 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 391
