...
set helplang=en
set modelines=0
set runtimepath=~/.vim,~/.vim/plugged/vim-table-mode,~/.vim/plugged/gruvbox,~/.vim/plugged/indentLine,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/plugged/indentLine/after,~/.vim/after
set shiftwidth=4
set softtabstop=4
set tabstop=4
set wildignore=*.pyc
...
silent only
silent tabonly
cd ~/new_model_code/src/nm/scratch_test/expt/SOA/ice_shelf
...
badd +21 soa_test.py
badd +465 ../../../../utils/grid.py
badd +20 ../../../../utils/constants_years.py
badd +16 ../../../../utils/constants.py
badd +25 ../../../../solvers/nonlinear_solvers.py
badd +1 ../../../../solvers/residuals.py
badd +0 ../../2D_tests/time_dep/ice_shelf.py
argglobal
%argdel
$argadd soa_test.py
edit ../../2D_tests/time_dep/ice_shelf.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 1150 - ((34 * winheight(0) + 28) / 56)
...
wincmd w
argglobal
if bufexists(fnamemodify("../../../../solvers/nonlinear_solvers.py", ":p")) | buffer ../../../../solvers/nonlinear_solvers.py | else | edit ../../../../solvers/nonlinear_solvers.py | endif
balt ../../../../solvers/residuals.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 213 - ((13 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 213
...
wincmd w
argglobal
if bufexists(fnamemodify("../../../../solvers/residuals.py", ":p")) | buffer ../../../../solvers/residuals.py | else | edit ../../../../solvers/residuals.py | endif
balt soa_test.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
...
silent! normal! zE
let &fdl = &fdl
let s:l = 273 - ((9 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 273
