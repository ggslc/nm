...
silent only
silent tabonly
cd ~/new_model_code/src/nm/scratch_test/expt/mismip_plus
...
badd +812 mismip_plus_simple.py
badd +804 ../2D_tests/ice_shelf_newton.py
badd +0 ../2D_tests/larsen_c.py
argglobal
%argdel
$argadd mismip_plus_simple.py
edit mismip_plus_simple.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 766 - ((3 * winheight(0) + 26) / 53)
...
wincmd w
argglobal
if bufexists(fnamemodify("../2D_tests/ice_shelf_newton.py", ":p")) | buffer ../2D_tests/ice_shelf_newton.py | else | edit ../2D_tests/ice_shelf_newton.py | endif
balt mismip_plus_simple.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 804 - ((25 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 804
...
wincmd w
argglobal
if bufexists(fnamemodify("../2D_tests/larsen_c.py", ":p")) | buffer ../2D_tests/larsen_c.py | else | edit ../2D_tests/larsen_c.py | endif
balt ../2D_tests/ice_shelf_newton.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
