...
set helplang=en
set modelines=0
set runtimepath=~/.vim,~/.vim/plugged/codeium.vim,~/.vim/plugged/vim-table-mode,~/.vim/plugged/gruvbox,~/.vim/plugged/indentLine,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/plugged/indentLine/after,~/.vim/after
set shiftwidth=4
set softtabstop=4
set tabstop=4
set wildignore=*.pyc
...
silent only
silent tabonly
cd ~/Library/CloudStorage/OneDrive-UniversityofLeeds/Documents/new_model/code/codebase/scratch_test/expt
...
badd +1 sparse_implcit_coupled_test.py
badd +222 sparse_jacobian_petsc_test.py
badd +198 ../sparsity_utils.py
argglobal
%argdel
$argadd sparse_implcit_coupled_test.py
$argadd sparse_jacobian_petsc_test.py
edit sparse_implcit_coupled_test.py
...
argglobal
terminal ++curwin ++cols=102 ++rows=6 
let s:term_buf_6 = bufnr()
balt sparse_implcit_coupled_test.py
...
argglobal
2argu
if bufexists(fnamemodify("../sparsity_utils.py", ":p")) | buffer ../sparsity_utils.py | else | edit ../sparsity_utils.py | endif
balt sparse_jacobian_petsc_test.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 41 - ((26 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 41
...
silent! normal! zE
let &fdl = &fdl
let s:l = 222 - ((25 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 222
