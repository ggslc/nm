...
set helplang=en
set modelines=0
set runtimepath=~/.vim,~/.vim/plugged/windsurf.vim,~/.vim/plugged/vim-table-mode,~/.vim/plugged/gruvbox,~/.vim/plugged/indentLine,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/plugged/indentLine/after,~/.vim/after
set shiftwidth=4
set softtabstop=4
set tabstop=4
set wildignore=*.pyc
...
argglobal
2argu
if bufexists(fnamemodify("../DIVA/mom_only.py", ":p")) | buffer ../DIVA/mom_only.py | else | edit ../DIVA/mom_only.py | endif
balt sparse_poisson.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
