...
silent only
silent tabonly
cd ~/new_model_code/src/nm/scratch_test/expt/2D_tests/time_dep
...
badd +704 ice_shelf.py
badd +319 ../../../../utils/grid.py
badd +49 ../../../../solvers/linear_solvers.py
badd +196 ../../../../utils/sparsity_utils.py
argglobal
%argdel
$argadd ice_shelf.py
edit ice_shelf.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 704 - ((34 * winheight(0) + 23) / 46)
...
wincmd w
argglobal
if bufexists(fnamemodify("../../../../utils/grid.py", ":p")) | buffer ../../../../utils/grid.py | else | edit ../../../../utils/grid.py | endif
balt ice_shelf.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
...
silent! normal! zE
let &fdl = &fdl
let s:l = 572 - ((31 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 572
