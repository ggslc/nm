...
silent only
silent tabonly
cd ~/new_model_code/src/nm/scratch_test/expt/2D_tests
...
badd +1 test_inverse_problem.py
badd +0 ../../../../nm/scratch_test/inverse/inverse_test_1d_ice_shelf.py
argglobal
%argdel
$argadd test_inverse_problem.py
edit test_inverse_problem.py
