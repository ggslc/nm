...
silent only
silent tabonly
cd ~/new_model_code/src/nm/scratch_test/expt/ice_shelf_shear_damage_experiment
...
badd +719 ice_shelf_shear_damage.py
badd +92 ../coupled_damage_ice_shelf_expt.py
badd +0 ../damage/simple_damage_explicit.py
argglobal
%argdel
$argadd ice_shelf_shear_damage.py
edit ice_shelf_shear_damage.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 719 - ((32 * winheight(0) + 21) / 43)
...
wincmd w
argglobal
if bufexists(fnamemodify("../damage/simple_damage_explicit.py", ":p")) | buffer ../damage/simple_damage_explicit.py | else | edit ../damage/simple_damage_explicit.py | endif
balt ../coupled_damage_ice_shelf_expt.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 141 - ((0 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 141
