...
silent only
silent tabonly
cd ~/Library/CloudStorage/OneDrive-UniversityofLeeds/Documents/new_model/code/codebase/scratch_test/expt/stability_analysis
...
badd +1 basic_setup.py
badd +1 ../implicit_coupled_test.py
badd +0 ../damage/simple_damage.py
argglobal
%argdel
$argadd basic_setup.py
$argadd ../implicit_coupled_test.py
edit basic_setup.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 365 - ((35 * winheight(0) + 21) / 43)
...
argglobal
2argu
if bufexists(fnamemodify("../damage/simple_damage.py", ":p")) | buffer ../damage/simple_damage.py | else | edit ../damage/simple_damage.py | endif
balt ../implicit_coupled_test.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 384 - ((13 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 384
...
silent! normal! zE
let &fdl = &fdl
let s:l = 191 - ((9 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 191
