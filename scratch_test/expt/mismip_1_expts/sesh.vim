...
silent only
silent tabonly
cd ~/Library/CloudStorage/OneDrive-UniversityofLeeds/Documents/new_model/code/codebase/scratch_test/expt/mismip_1_expts
...
badd +261 solver_etc.py
badd +345 ~/Library/CloudStorage/OneDrive-UniversityofLeeds/Documents/new_model/code/codebase/scratch_test/expt/stability_analysis/basic_setup.py
argglobal
%argdel
$argadd solver_etc.py
edit solver_etc.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 264 - ((26 * winheight(0) + 26) / 53)
...
wincmd w
argglobal
if bufexists(fnamemodify("solver_etc.py", ":p")) | buffer solver_etc.py | else | edit solver_etc.py | endif
balt ~/Library/CloudStorage/OneDrive-UniversityofLeeds/Documents/new_model/code/codebase/scratch_test/expt/stability_analysis/basic_setup.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 455 - ((16 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 455
...
wincmd w
argglobal
if bufexists(fnamemodify("~/Library/CloudStorage/OneDrive-UniversityofLeeds/Documents/new_model/code/codebase/scratch_test/expt/stability_analysis/basic_setup.py", ":p")) | buffer ~/Library/CloudStorage/OneDrive-UniversityofLeeds/Documents/new_model/code/codebase/scratch_test/expt/stability_analysis/basic_setup.py | else | edit ~/Library/CloudStorage/OneDrive-UniversityofLeeds/Documents/new_model/code/codebase/scratch_test/expt/stability_analysis/basic_setup.py | endif
balt solver_etc.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
...
silent! normal! zE
let &fdl = &fdl
let s:l = 718 - ((18 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 718
