...
def linear_solver_with_cvjp(linear_solver):
    @custom_vjp
    def linear_solve(A, b):
        # the reason for writing it out like this, despite the fact that lalg.solve
        #is already differentiable and probably has a primitive vjp rule is that we
        #want to be able to easily replace the solver.
        solution = linear_solver(A, b)
        return solution
