...
silent only
silent tabonly
cd ~/Library/CloudStorage/OneDrive-UniversityofLeeds/Documents/new_model/code/codebase/scratch_test/diva
...
badd +1 iterative_implicit_ssa.py
badd +1 ../expt/implicit_coupled_test.py
argglobal
%argdel
$argadd iterative_implicit_ssa.py
$argadd ../expt/implicit_coupled_test.py
edit iterative_implicit_ssa.py
...
silent! normal! zE
let &fdl = &fdl
let s:l = 213 - ((58 * winheight(0) + 29) / 59)
...
argglobal
2argu
terminal ++curwin ++cols=117 ++rows=29 
let s:term_buf_4 = bufnr()
balt ../expt/implicit_coupled_test.py
...
argglobal
2argu
balt iterative_implicit_ssa.py
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
